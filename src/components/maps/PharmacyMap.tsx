    ...
    <div className="relative w-full h-full flex flex-col">
      ...
      <div className="bg-white p-3 border-b border-gray-200 flex flex-wrap items-center justify-between gap-2">
        <form onSubmit={handleZipCodeSubmit} className="flex items-center">
          ...
          <button
            type="submit"
            className={`ml-2 text-white bg-[#006142] hover:bg-[#22A307] focus:ring-4 focus:outline-none focus:ring-[#EFFDF6] font-medium rounded-lg text-sm px-4 py-2.5 ${loading ? 'opacity-75 cursor-not-allowed' : ''}`}
            disabled={loading}
          >
            {loading ? (
